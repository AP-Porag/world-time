              ...
              <div class="col-lg-8">
                <div>
                  ...
                  <p class="fs-13 text-muted mb-0">
                    <span class="mr-2">Photo </span>{{post.created_at}}
                  </p>
                  ...
                  <p class="mb-4 fs-15" v-html="post.content"></p>
                </div>
                <div>
                  <h1 class="font-weight-600 mb-1">
...
export default {
  ...
  methods: {
    async getSinglePost() {
      const data = await this.$axios.$get('http://127.0.0.1:8000/api/post/'+this.$route.params.slug)
      this.post = data;
    }
  }
}
